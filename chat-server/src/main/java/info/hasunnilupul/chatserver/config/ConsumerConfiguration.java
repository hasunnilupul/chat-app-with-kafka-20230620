package info.hasunnilupul.chatserver.config;
...
import static info.hasunnilupul.chatserver.constants.KafkaConstants.KAFKA_BROKER;
...
public class ConsumerConfiguration {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(JsonDeserializer.TRUSTED_PACKAGES, "info.hasunnilupul.chatserver.modal");
